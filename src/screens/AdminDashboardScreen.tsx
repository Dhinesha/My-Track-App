...
const ACTIONS = [
  { id: 'member', label: 'Member Management', icon: 'account-cog', color: '#2196F3' },
  { id: 'vehicle', label: 'Vehicle Management', icon: 'bus-clock', color: '#FF9800' },
  { id: 'trip', label: 'Trip Overview', icon: 'airplane-takeoff', color: '#4CAF50' },
  { id: 'hotel', label: 'Hotel Management', icon: 'office-building-cog', color: '#9C27B0' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={styles.analyticsSection}>
          ...
          <View style={styles.chartPlaceholder}>
            <MaterialCommunityIcons name="chart-bell-curve-cumulative" size={48} color={Colors.border.default} />
            <Text style={styles.placeholderText}>Activity chart visualization</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.statRow}>
              ...
              <Text style={[styles.statValue, { color: Colors.status.success }]}>12</Text>
            </View>
            <View style={styles.statRow}>
              <Text style={styles.statName}>Remaining</Text>
              <Text style={[styles.statValue, { color: Colors.status.error }]}>3</Text>
            </View>
